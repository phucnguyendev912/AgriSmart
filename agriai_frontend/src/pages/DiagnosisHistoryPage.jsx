  ...
  return (
    <main className="pt-24 lg:pt-32 pb-12 px-4 md:px-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {/* List/Table Container - Expanded Full Width */}
          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-outline-variant/10">
                {loading ? (
                    <tr><td colSpan="7" className="px-6 py-8 text-center text-on-surface-variant font-medium">Đang tải lịch sử...</td></tr>
                ) : historyList.length === 0 ? (
                    <tr><td colSpan="7" className="px-6 py-8 text-center text-on-surface-variant font-medium">Chưa có lịch sử chẩn đoán nào.</td></tr>
