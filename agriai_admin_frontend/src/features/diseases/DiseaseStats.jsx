...
const DiseaseStats = ({ totalDiseases, totalCropTypes }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <StatCard icon="coronavirus" label="Tổng số bệnh" value={totalDiseases || 0} iconBg="bg-primary/10" iconColor="text-primary" />
    <StatCard icon="grass" label="Loại cây trồng" value={totalCropTypes || 0} iconBg="bg-emerald-100" iconColor="text-emerald-700" />
  </div>
);
