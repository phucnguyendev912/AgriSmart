...
const UserStats = ({ total, active }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <StatCard icon="group" label="Tổng số" value={total} iconBg="bg-primary/10" iconColor="text-primary" />
    <StatCard icon="check_circle" label="Hoạt động" value={active} iconBg="bg-emerald-100" iconColor="text-emerald-700" />
  </div>
);
