...
public class AuthService {
    ...
    public UserResponse register(RegisterRequest request) {
        ...
        com.phucnguyen.agriai.entity.User newUser = com.phucnguyen.agriai.entity.User.builder()
        ...
        com.phucnguyen.agriai.entity.User saved = userRepository.save(newUser);
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        com.phucnguyen.agriai.entity.User user = userRepository.findByEmail(normalizedEmail)
        ...
        return LoginResponse.builder()
                .accessToken(jwtService.generateToken(springUser))
    ...
    public LoginResponse refreshToken(String refreshToken) {
        ...
        com.phucnguyen.agriai.entity.User user = userRepository.findByEmail(userEmail)
    ...
    private UserDetails toSpringUser(com.phucnguyen.agriai.entity.User user) {
